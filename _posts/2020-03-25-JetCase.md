...
The aim of this project is to create a mobile computer system inside a Pelican Case, based on the Nvidia Jetson Nano. With further development this device could be used as an easily transportable UAV ground station. The main inspiration for this project is [Back7's Off-Grid Cyberdeck](https://back7.co/home/raspberry-pi-recovery-kit)
...
So instead, a configuration similar to 
