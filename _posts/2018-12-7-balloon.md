...
Wind velocity components from [GFS data][gfs_data] is used to determine the direction and distance the balloon will travel horizontally.
  [gfs_data]: https://www.ncdc.noaa.gov/data-access/model-data/model-datasets/global-forcast-system-gfs
