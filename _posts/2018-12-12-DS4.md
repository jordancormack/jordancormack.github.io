...
with ControllerResource() as joystick:
    ...
    while joystick.connected:
        # Get the left x and y axes, and the hold time for the home button.
        # The result is a list, and we can use Python's implicit decomposition
        # to read the values of that list into three variables in one go:
